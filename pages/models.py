...
class ProductPrice(models.Model):
    ...
    produit = models.ForeignKey(Product, on_delete=models.CASCADE)  # En minuscules
    point_de_vente = models.ForeignKey(PointOfSale, on_delete=models.CASCADE)  # En minuscules
